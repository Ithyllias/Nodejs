...
define(function (require, exports, module) {
  ...
  exports['test urls'] = function (assert, util) {
    ...
    assertUrl('http://');
    assertUrl('http://www.js.example.com');
    assertUrl('http://user:pass@www.js.example.com');
    assertUrl('http://www.js.example.com:80');
    assertUrl('http://www.js.example.com/');
    assertUrl('http://www.js.example.com/foo/bar');
    assertUrl('http://www.js.example.com/foo/bar/');
    assertUrl('http://user:pass@www.js.example.com:80/foo/bar/');

    assertUrl('//');
    assertUrl('//www.js.example.com');
    assertUrl('file:///www.js.example.com');
  ...
  exports['test normalize()'] = function (assert, util) {
    ...
    assert.equal(libUtil.normalize('http://www.js.example.com'), 'http://www.js.example.com');
    assert.equal(libUtil.normalize('http://www.js.example.com/'), 'http://www.js.example.com/');
    assert.equal(libUtil.normalize('http://www.js.example.com/./..//a/b/c/.././d//'), 'http://www.js.example.com/a/b/d/');
  };
  ...
  exports['test join()'] = function (assert, util) {
    ...
    assert.equal(libUtil.join('a', 'http://www.js.example.com'), 'http://www.js.example.com');
    ...
    assert.equal(libUtil.join('', 'http://www.js.example.com'), 'http://www.js.example.com');
    assert.equal(libUtil.join('.', 'http://www.js.example.com'), 'http://www.js.example.com');
    ...
    assert.equal(libUtil.join('http://foo.org//', ''), 'http://foo.org/');
    assert.equal(libUtil.join('http://foo.org//', '.'), 'http://foo.org/');
    assert.equal(libUtil.join('//www.js.example.com', ''), '//www.js.example.com/');
    assert.equal(libUtil.join('//www.js.example.com', '.'), '//www.js.example.com/');
    ...
    assert.equal(libUtil.join('http://foo.org/a', 'http://www.js.example.com'), 'http://www.js.example.com');
    ...
    assert.equal(libUtil.join('http://', 'www.js.example.com'), 'http://www.js.example.com');
    assert.equal(libUtil.join('file:///', 'www.js.example.com'), 'file:///www.js.example.com');
    assert.equal(libUtil.join('http://', 'ftp://example.com'), 'ftp://example.com');

    assert.equal(libUtil.join('http://www.js.example.com', '//foo.org/bar'), 'http://foo.org/bar');
    assert.equal(libUtil.join('//www.js.example.com', '//foo.org/bar'), '//foo.org/bar');
  };
