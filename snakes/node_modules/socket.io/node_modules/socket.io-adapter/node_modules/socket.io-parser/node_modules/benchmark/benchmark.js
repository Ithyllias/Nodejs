...
;(function(window, undefined) {
   ...
   * http://www.js.itl.nist.gov/div898/handbook/eda/section3/eda3672.htm
   */
  var tTable = {
   ...
   * http://www.js.saburchill.com/IBbiology/stats/003.html
   */
  var uTable = {
    '5':  [0, 1, 2],
    '6':  [1, 2, 3, 5],
  ...
  function compare(other) {
    ...
    if (size1 + size2 > 30) {
      ...
      // http://www.js.statisticslectures.com/topics/mannwhitneyu/
      zStat = getZ(u);
      return abs(zStat) > 1.96 ? (zStat > 0 ? -1 : 1) : 0;
    }
    // ...the U value is less than or equal the critical U value
    // http://www.js.geoib.com/mann-whitney-u-test.html
  ...
  function reset() {
    ...
    if (me.running && !calledBy.abort) {
      ...
      // http://www.js.jslab.dk/articles/non.recursive.preorder.traversal.part4
